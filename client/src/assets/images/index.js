...
export const images = {
  races: [
    ...
    { name: 'elf', image: elf },
    { name: 'elfFemale', image: elfFemale },
    { name: 'orc', image: orc },
    { name: 'orcFemale', image: orcFemale },
    { name: 'human', image: human },
    { name: 'humanFemale', image: humanFemale },
  ],
  roles: [
    { name: 'cleric', image: cleric },
    { name: 'healer', image: healer },
    { name: 'mage', image: mage },
    { name: 'ranger', image: ranger },
    { name: 'templar', image: templar },
